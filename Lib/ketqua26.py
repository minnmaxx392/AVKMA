...
class SubWindow(object):
    def setup_ui(self, Dialog):
        ...
        self.table_model.setHorizontalHeaderLabels(["Tên file", "Phân loại"])

        self.table_view = QTableView(Dialog)
        self.table_view.setModel(self.table_model)
        self.table_view.setColumnWidth(0, 200)  # Cột tên file
        self.table_view.setColumnWidth(1, 100)  # Cột phân loại

        # Bảng 2
        self.table_model_2 = QStandardItemModel(Dialog)
        self.table_model_2.setHorizontalHeaderLabels(["Tên loại", "Số lượng"])

        self.table_view_2 = QTableView(Dialog)
        self.table_view_2.setModel(self.table_model_2)
        self.table_view_2.setColumnWidth(0, 100)
